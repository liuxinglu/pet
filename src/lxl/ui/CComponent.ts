module lxlPet {
	export class CComponent extends eui.Component{
		public constructor(skinName:string) {
			...
			this.skinName = lxlPet.Tool.callJS("getURLPet") + skinName;
		...
		private loadComplete():void {
			egret.Tween.get( this).wait(0.1).call(()=>{
				...
				this.dispatchEvent(new egret.Event(CEvent.LOAD_SKIN_COMPLETE_PET));
			}, this);
		}
		 ...
		 * 在自己上面弹出
		 */
		pop(com:lxlPet.CComponent, ani:boolean = false):void {
			com.addEventListener(lxlPet.CEvent.LOAD_SKIN_COMPLETE_PET, ()=>{
