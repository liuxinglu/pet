    ...
    (function (ui) {
        var CGroup = (function (_super) {
            ...
            CGroup.prototype._clickHandler = function (e) {
                var ee = lxlPet.Tool.copyObject(e);
                this.dispatchEvent(new lxlPet.CEvent(lxlPet.CEvent.CLICK_PET, ee));
            };
            ...
            CGroup.prototype.pop = function (com) {
                var _this = this;
                com.addEventListener(lxlPet.CEvent.LOAD_SKIN_COMPLETE_PET, function () {
        ...
        ui.CGroup = CGroup;
        __reflect(CGroup.prototype, "lxlPet.ui.CGroup");
    })(ui = lxlPet.ui || (lxlPet.ui = {}));
})(lxlPet || (lxlPet = {}));
